...
function AddOrderProducts({ dataProducts, setProductsOrders, productsOrders }: { dataProducts: IProduct[], setProductsOrders: Function, productsOrders: IProductOrder[] }) {
                        ...
                        <div className='d-flex flex-column p-2 ps-3 justify-content-around w-25 flex-fill'>
                            ...
                            <div className="d-flex justify-content-between">
                                <div className="d-flex flex-column me-2">
                                    ...
                                    <input type='text'
                                        onChange={(e) => handleChangeProdNum(e, product.id!, product.quantityLeft)}
